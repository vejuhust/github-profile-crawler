...
class WatchDog(BaseLogger):
    ...
    def _draw_chart_summary(self, data, filename="size_summary.svg"):
    ...
    def _draw_chart_crawl(self, data, filename="size_crawl.svg"):
        filename = join(config_report_folder, filename)
    ...
    def _draw_chart_page(self, data, filename="size_page.svg"):
        filename = join(config_report_folder, filename)
    ...
    def _draw_chart_profile(self, data, filename="size_profile.svg"):
        filename = join(config_report_folder, filename)
